...
import static net.vvakame.droppshare.listshare.SelectorHelper.installWatchingFile;
import static net.vvakame.droppshare.listshare.SelectorHelper.readWatchingFile;
...
public class ListShareActivity extends Activity implements LogTagIF,
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.add_dir:
			...
			boolean canResolve = AppExistsUtil.canResolveActivity(this,
		...
		new Thread() {
			...
			public void run() {
				...
				XmlUtil.writeXmlCache(ListShareActivity.this,
						PreferencesActivity
								.getDrozipName(ListShareActivity.this),
						appList);
